...
import View from './CalibrationMethodFrog.vue'
import { markRaw } from 'vue'

export class CalibrationMethodFrog implements ICalibrationMethod {
  readonly title: string = 'Froschkalibrierung'
  ...
  async checkPreConditions (sensor: Sensor): Promise<void> {
    ...
    const isBelowMaximalBackgroundNoise = Math.max(...analysisData.getDBAs()) < FrogCalibrationConfig.preConditions.maximalBackgroundNoise
