...
import { AudioCalculationService } from '../service/audioCalculationService'
...
export class AnalysisConfig implements MeydaAnalyzerOptions {
  ...
  constructor (
    ...
    frequencies: Array<number> = AudioCalculationService.calcFrequencies(sampleRate, bufferSize)
  ) {
